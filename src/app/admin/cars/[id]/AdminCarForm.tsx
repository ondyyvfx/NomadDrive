...
export function AdminCarForm({ car }: { car: CarForRent | null }) {
    ...
    return (
        <div className="flex flex-col gap-5 fade-in-up">
            ...
            <div className="bg-white border border-black/[0.06] rounded-[16px] p-6">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <textarea
                            className="w-full px-3.5 py-3 bg-[#f5f5f7] border border-black/[0.08] rounded-[10px] text-[15px] text-[#1d1d1f] outline-none focus:border-accent focus:ring-3 focus:ring-[#0a5f4a]/[0.08] focus:bg-white transition-all resize-none font-mono text-[13px]"
                            rows={4}
            ...
            {/* Delete confirmation — desktop inline / mobile sheet */}
            {showDel && (
                <>
                    {/* Desktop */}
                    <div className="hidden md:block bg-white border border-[#ff3b30]/20 rounded-[16px] p-5 scale-in">
                        <p className="text-[15px] font-semibold tracking-tight mb-1">Удалить автомобиль?</p>
                        <p className="text-[13px] text-[#6e6e73] mb-4">Это действие нельзя отменить</p>
                        <div className="flex gap-3">
                            <button onClick={() => setShowDel(false)} className="flex-1 h-10 bg-[#f5f5f7] border border-black/[0.08] rounded-[10px] text-[14px] font-medium hover:bg-black/[0.04] transition-colors">
                                Отмена
                            </button>
                    ...
                    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-[20px] px-5 pt-5 pb-8 shadow-lg slide-in-from-bottom">
                        ...
                        <p className="text-[17px] font-semibold tracking-tight mb-1">Удалить автомобиль?</p>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <button onClick={() => setShowDel(false)} className="w-full h-12 bg-[#f5f5f7] text-[#1d1d1f] font-medium rounded-[12px] border border-black/[0.08] text-[16px]">
                                Отмена
                            </button>
                        </div>
                    </div>
